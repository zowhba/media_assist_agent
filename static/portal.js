...
const TOOLS = [
  ...
  },
  {
    ...
    icon: "📊",
    title: "주간 업무 보고 작성",
    desc: "내 보고 형식을 등록해 두고, 이번 주 업무 메모를 붙여넣으면 형식에 맞춘 주간 보고 초안을 생성합니다.",
    href: "/tools/weekly",
    status: "active",
    settingsHref: "/tools/weekly#format",
  },
  {
    id: "monthly",
    icon: "🗂️",
    title: "월간 운영보고 이슈 정리",
    desc: "Jira에서 export 한 파일을 올리면 운영보고용 이슈표(.xls)와 PPT용 통계·요약·Insight를 자동 생성합니다.",
    href: "/tools/monthly",
    status: "active",
